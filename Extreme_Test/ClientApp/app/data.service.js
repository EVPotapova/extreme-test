...
var DataService = (function () {
    function DataService(http) {
        this.http = http;
        this.url = "/api/Vacancy";
    }
    DataService.prototype.getVacancies = function (vacancyFilter, listOptions) {
    ...
    DataService.prototype.refreshVacanciesList = function () {
        return this.http.post(this.url + '/refresh', null);
    };
    DataService.prototype.getVacancy = function (id) {
